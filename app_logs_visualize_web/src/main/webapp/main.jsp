...
<div class="header bg-main">
    ...
    <div class="head-l"><a class="button button-little bg-green" href="index.jsp" target="_blank">
        <span class="icon-home"></span> 实时统计页面</a> &nbsp;&nbsp;<a href="index.jsp" class="button button-little bg-blue">
        <span class="icon-wrench"></span> 清除缓存</a> &nbsp;&nbsp;<a class="button button-little bg-red" href="main.jsp">
...
<div class="leftnav">
    ...
    <ul>
        ...
        <li><a href="usagefrequency.jsp" target="right"><span class="icon-caret-right"></span>使用频率</a></li>
        <li><a href="erroranalysis.jsp" target="right"><span class="icon-caret-right"></span>错误列表</a></li>
    </ul>
...
<ul class="bread">
    <li><a href="newusers.jsp" target="right" class="icon-home"> 首页</a></li>
    <li><a href="##" id="a_leader_txt">网站信息</a></li>
</ul>
<div class="admin">
    <iframe scrolling="auto" rameborder="0" src="newusers.jsp" name="right" width="100%" height="100%"></iframe>
</div>
