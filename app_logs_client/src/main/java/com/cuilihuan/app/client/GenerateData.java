package com.cuilihuan.app.client;

import com.alibaba.fastjson.JSONObject;
import com.cuilihuan.app.common.*;
...
public class GenerateData {
    ...
    private static String[] appId = {"sdk34734","sdk34735","sdk34736"};//应用唯一标识
    private static String[] tenantIds = {"cake"};//租户唯一标识,企业用户
    private static String[] deviceIds = initDeviceId();//设备唯一标识
    private static String[] appVersions = {"3.2.1", "3.2.2","3.2.3"};//版本
    ...
    private static void initLogCommon(AppBaseLog baselog){
        ...
        createdAtMsS = initCreatedAtMs();
        // 日志创建时间
        baselog.setCreatedAtMs(createdAtMsS[random.nextInt((createdAtMsS.length))]);
        // appid
        baselog.setAppId(appId[random.nextInt(appId.length)]);
        // 租户唯一标识,企业用户
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 200000000; i++) {
            ...
            appStartupLogs = initAppStartupLogs();
